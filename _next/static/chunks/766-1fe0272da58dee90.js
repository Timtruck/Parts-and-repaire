...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[766], {
    ...
    1037: (t, e, i) => {
        i.d(e, {
            ...
            TU: () => function t(e, i) {
                if (e)
                    return "function" == typeof e && m() ? v(e, i) : c(e) ? y(e) : Array.isArray(e) ? e.map(e => t(e, i) || x.easeOut) : x[e]
            }
            ,
            YE: () => l,
            c$: () => R,
        ...
        var s = i(178);
        let n = (0,
        s.p)( () => void 0 !== window.ScrollTimeline);
        class r {
            constructor(t) {
        ...
        ;
        function g(t) {
            return !!("function" == typeof t && m() || !t || "string" == typeof t && (t in x || m()) || c(t) || Array.isArray(t) && t.every(g))
        }
        let y = ([t,e,i,s]) => `cubic-bezier(${t}, ${e}, ${i}, ${s})`
          , x = {
            linear: "linear",
            ease: "ease",
            easeIn: "ease-in",
        ...
        function P(t, e, i) {
            ...
            if ("string" == typeof t) {
                let n = document;
                e && (n = e.current);
                let r = null != (s = null == i ? void 0 : i[t]) ? s : n.querySelectorAll(t);
        ...
        let S = (t, e) => !!e && (t === e || S(t, e.parentElement))
              ...
              , o = t => {
                ...
                let r = e(t)
                  , o = (t, e) => {
                    ...
                    k(t) && M.has(s) && (M.delete(s),
                    "function" == typeof r && r(t, {
                        success: e
                    }))
                }
                  , a = t => {
                    o(t, i.useGlobalTarget || S(s, t.target))
                }
                  , l = t => {
                    o(t, !1)
                }
    ...
    3657: (t, e, i) => {
        ...
        let d = ["animate", "whileInView", "whileFocus", "whileHover", "whileTap", "whileDrag", "exit"]
          , c = ["initial", ...d];
        var p, m, f = i(1037);
        let v = ["transformPerspective", "x", "y", "z", "translateX", "translateY", "translateZ", "scale", "scaleX", "scaleY", "rotate", "rotateX", "rotateY", "rotateZ", "skew", "skewX", "skewY"]
          , g = new Set(v)
          , y = new Set(["width", "height", "top", "left", "right", "bottom", ...v])
        ...
        var P = i(4119);
        let T = ["read", "resolveKeyframes", "update", "preRender", "render", "postRender"];
        function b(t, e) {
            let i = !1
              , s = !0
              , n = {
        ...
        let {schedule: A, cancel: S, state: V, steps: E} = b("undefined" != typeof requestAnimationFrame ? requestAnimationFrame : P.l, !0);
        function M() {
            s = void 0
        }
        let D = {
            now: () => (void 0 === s && D.set(V.isProcessing || w.useManualTiming ? V.timestamp : performance.now()),
            s),
            set: t => {
                s = t,
                queueMicrotask(M)
        ...
        class R {
            ...
            add(t) {
                return C(this.subscriptions, t),
                () => k(this.subscriptions, t)
            }
            notify(t, e, i) {
        ...
        let U = t => t.replace(/([a-z])([A-Z])/gu, "$1-$2").toLowerCase()
          , I = "data-" + U("framerAppearId");
        var N = i(7290);
        let $ = {
            current: !1
        }
          , W = (t, e, i) => (((1 - 3 * i + 3 * e) * t + (3 * i - 6 * e)) * t + 3 * e) * t;
        function z(t, e, i, s) {
            return t === e && i === s ? P.l : n => 0 === n || 1 === n ? n : W(function(t, e, i, s, n) {
                let r, o, a = 0;
                do
                    (r = W(o = e + (i - e) / 2, s, n) - t) > 0 ? i = o : e = o;
        ...
        let X = t => e => e <= .5 ? t(2 * e) / 2 : (2 - t(2 * (1 - e))) / 2
          ...
          , q = H(Y)
          , K = X(q)
          , G = t => (t *= 2) < 1 ? .5 * q(t) : .5 * (2 - Math.pow(2, -10 * (t - 1)))
          , _ = t => 1 - Math.sin(Math.acos(t))
          , Z = H(_)
          , J = X(_)
          , Q = t => /^0[^.\s]+$/u.test(t)
          , tt = (t, e, i) => i > e ? e : i < t ? t : i
          , te = {
          ...
          , ta = (t, e) => i => !!("string" == typeof i && to.test(i) && i.startsWith(t) || e && null != i && Object.prototype.hasOwnProperty.call(i, e))
          , tl = (t, e, i) => s => {
            if ("string" != typeof s)
                return s;
          ...
          , tu = {
            ...te,
            transform: t => Math.round(tt(0, 255, t))
        }
          , th = {
            test: ta("rgb", "red"),
            parse: tl("red", "green", "blue"),
            transform: ({red: t, green: e, blue: i, alpha: s=1}) => "rgba(" + tu.transform(t) + ", " + tu.transform(e) + ", " + tu.transform(i) + ", " + tn(ti.transform(s)) + ")"
        }
          , td = {
            test: ta("#"),
            parse: function(t) {
          ...
          , tx = {
            ...
            transform: ({hue: t, saturation: e, lightness: i, alpha: s=1}) => "hsla(" + Math.round(t) + ", " + tm.transform(tn(e)) + ", " + tm.transform(tn(i)) + ", " + tn(ti.transform(s)) + ")"
        }
          , tw = {
            test: t => th.test(t) || td.test(t) || tx.test(t),
            parse: t => th.test(t) ? th.parse(t) : tx.test(t) ? tx.parse(t) : td.parse(t),
            transform: t => "string" == typeof t ? t : t.hasOwnProperty("red") ? th.transform(t) : tx.transform(t)
        }
          , tP = /(?:#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\))/giu
          , tT = "number"
          , tb = "color"
          , tA = /var\s*\(\s*--(?:[\w-]+\s*|[\w-]+\s*,(?:\s*[^)(\s]|\s*\((?:[^)(]|\([^)(]*\))*\))+\s*)\)|#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\)|-?(?:\d+(?:\.\d+)?|\.\d+)/giu;
        function tS(t) {
            let e = t.toString()
              , i = []
              , s = {
              ...
              , n = []
              , r = 0
              , o = e.replace(tA, t => (tw.test(t) ? (s.color.push(r),
            n.push(tb),
            i.push(tw.parse(t))) : t.startsWith("var(") ? (s.var.push(r),
            n.push("var"),
        ...
        function tE(t) {
            ...
            return t => {
                ...
                for (let r = 0; r < s; r++)
                    ...
                    void 0 !== t[r]) {
                        let e = i[r];
                        e === tT ? n += tn(t[r]) : e === tb ? n += tw.transform(t[r]) : n += t[r]
                    }
                return n
            }
        }
        let tM = t => "number" == typeof t ? 0 : t
          , tD = {
            test: function(t) {
                var e, i;
                return isNaN(t) && "string" == typeof t && ((null == (e = t.match(tr)) ? void 0 : e.length) || 0) + ((null == (i = t.match(tP)) ? void 0 : i.length) || 0) > 0
            },
            parse: tV,
            createTransformer: tE,
            getAnimatableNone: function(t) {
                let e = tV(t);
                return tE(t)(e.map(tM))
            }
        }
          , tC = new Set(["brightness", "contrast", "saturate", "opacity"]);
        function tk(t) {
        ...
        let tR = /\b([a-z-]*)\(.*?\)/gu
          ...
          , tF = {
            ...
            marginBottom: tf,
            marginLeft: tf,
            backgroundPositionX: tf,
            backgroundPositionY: tf,
            rotate: tp,
            rotateX: tp,
            rotateY: tp,
            rotateZ: tp,
        ...
        function tG() {
            ...
            tK = !1,
            tq = !1,
            tY.forEach(t => t.complete()),
            tY.clear()
        }
        function t_() {
            tY.forEach(t => {
                t.readKeyframes(),
                t.needsMeasurement && (tK = !0)
            }
            )
        }
        class tZ {
            ...
            scheduleResolve() {
                this.isScheduled = !0,
                this.isAsync ? (tY.add(this),
                tq || (tq = !0,
                A.read(t_),
                A.resolveKeyframes(tG))) : (this.readKeyframes(),
                this.complete())
            }
            readKeyframes() {
        ...
        let tJ = P.l
          , tQ = P.l
          , t0 = t => /^-?(?:\d+(?:\.\d+)?|\.\d+)$/u.test(t)
          , t1 = t => e => "string" == typeof e && e.startsWith(t)
          , t2 = t1("--")
          , t5 = t1("var(--")
          , t3 = t => !!t5(t) && t9.test(t.split("/*")[0].trim())
          , t9 = /var\(--(?:[\w-]+\s*|[\w-]+\s*,(?:\s*[^)(\s]|\s*\((?:[^)(]|\([^)(]*\))*\))+\s*)\)$/iu
          , t4 = /^var\(--(?:([\w-]+)|([\w-]+), ?([a-zA-Z\d ()%#.,-]+))\)/u
          , t6 = t => e => e.test(t)
          , t7 = [te, tf, tm, tp, tg, tv, {
            test: t => "auto" === t,
            parse: t => t
        }]
          , t8 = t => t7.find(t6(t));
        class et extends tZ {
            ...
            readKeyframes() {
                ...
                for (let i = 0; i < t.length; i++) {
                    let s = t[i];
                    if ("string" == typeof s && t3(s = s.trim())) {
                        let n = function t(e, i, s=1) {
                            tQ(s <= 4, `Max CSS variable fallback depth detected in property "${e}". This may indicate a circular fallback dependency.`);
                            let[n,r] = function(t) {
                                let e = t4.exec(t);
                                if (!e)
                                    return [, ];
                            ...
                            if (o) {
                                let t = o.trim();
                                return t0(t) ? parseFloat(t) : t
                            }
                            return t3(r) ? t(r, i, s + 1) : r
                        }(s, e.current);
                        void 0 !== n && (t[i] = n),
            ...
            resolveNoneKeyframes() {
                ...
                for (let e = 0; e < t.length; e++) {
                    var s;
                    ("number" == typeof (s = t[e]) ? 0 === s : null === s || "none" === s || "0" === s || Q(s)) && i.push(e)
                }
                i.length && function(t, e, i) {
                    let s, n = 0;
                    for (; n < t.length && !s; ) {
                        let e = t[n];
                        "string" == typeof e && !tI.has(e) && tS(e).values.length && (s = t[n]),
                        n++
                    }
                    if (s && i)
                        for (let n of e)
            ...
            measureInitialState() {
                ...
                this.measuredOrigin = tH[i](t.measureViewportBox(), window.getComputedStyle(t.current)),
            ...
            measureEndState() {
                ...
                let r = s.length - 1
                  , o = s[r];
                s[r] = tH[i](e.measureViewportBox(), window.getComputedStyle(e.current)),
        ...
        let ee = (t, e) => "zIndex" !== e && !!("number" == typeof t || Array.isArray(t) || "string" == typeof t && (tD.test(t) || "0" === t) && !t.startsWith("url("))
          , ei = t => null !== t;
        ...
        class en {
            ...
            get resolved() {
                return this._resolved || this.hasAttemptedResolve || (t_(),
                tG()),
                this._resolved
            }
            onKeyframesResolved(t, e) {
                ...
                if (!l && !function(t, e, i, s) {
                    ...
                    let r = t[t.length - 1]
                      , o = ee(n, e)
                      , a = ee(r, e);
                    return tJ(o === a, `You are trying to animate ${e} from "${n}" to "${r}". ${n} is not an animatable value - to enable this animation set ${n} to a value animatable to ${r} via the \`style\` property.`),
                    !!o && !!a && (function(t) {
                        let e = t[0];
                        if (1 === t.length)
                            return !0;
        ...
        let el = (t, e, i) => {
          ...
          , eu = [td, th, tx];
        function eh(t) {
            let e = eu.find(e => e.test(t));
            if (tJ(!!e, `'${t}' is not an animatable color. Use the equivalent color code instead.`),
            !e)
                return !1;
            let i = e.parse(t);
            return e === tx && (i = function({hue: t, saturation: e, lightness: i, alpha: s}) {
                t /= 360,
                i /= 100;
                let n = 0
                  , r = 0
        ...
        let ed = (t, e) => {
            ...
            return t => (n.red = el(i.red, s.red, t),
            n.green = el(i.green, s.green, t),
            n.blue = el(i.blue, s.blue, t),
        ...
        function ev(t) {
            return "number" == typeof t ? ef : "string" == typeof t ? t3(t) ? ea : tw.test(t) ? ed : ex : Array.isArray(t) ? eg : "object" == typeof t ? tw.test(t) ? ed : ey : ea
        }
        function eg(t, e) {
            let i = [...t]
              , s = i.length
              , n = t.map( (t, i) => ev(t)(t, e[i]));
            return t => {
                for (let e = 0; e < s; e++)
                    i[e] = n[e](t);
                return i
        ...
        function ey(t, e) {
            let i = {
              ...
              , s = {};
            for (let n in i)
                void 0 !== t[n] && void 0 !== e[n] && (s[n] = ev(t[n])(t[n], e[n]));
            return t => {
                for (let e in s)
                    i[e] = s[e](t);
                return i
        ...
        let ex = (t, e) => {
            let i = tD.createTransformer(e)
              , s = tS(t)
              , n = tS(e);
            return s.indexes.var.length === n.indexes.var.length && s.indexes.color.length === n.indexes.color.length && s.indexes.number.length >= n.indexes.number.length ? em.has(t) && !n.values.length || em.has(e) && !s.values.length ? function(t, e) {
                return em.has(t) ? i => i <= 0 ? t : e : i => i >= 1 ? e : t
            }(t, e) : ep(eg(function(t, e) {
                var i;
                let s = []
                  , n = {
                    color: 0,
                ...
                return s
            }(s, n), n.values), i) : (tJ(!0, `Complex values '${t}' and '${e}' too different to mix. Ensure all colors are of the same type, and that each contains the same quantity of number and color values. Falling back to instant transition.`),
            ea(t, e))
        }
        ;
        function ew(t, e, i) {
            return "number" == typeof t && "number" == typeof e && "number" == typeof i ? er(t, e, i) : ev(t)(t, e)
        }
        function eP(t, e, i) {
            var s, n;
        ...
        function eE(t=eT.visualDuration, e=eT.bounce) {
            let i, s = "object" != typeof t ? {
                visualDuration: t,
                keyframes: [0, 1],
                bounce: e
            } : t, {restSpeed: n, restDelta: r} = s, o = s.keyframes[0], a = s.keyframes[s.keyframes.length - 1], l = {
                done: !1,
                value: o
                ...
                if (!eV(t, eS) && eV(t, eA))
                    if (t.visualDuration) {
                        let i = 2 * Math.PI / (1.2 * t.visualDuration)
                          , s = i * i
                          , n = 2 * tt(.05, 1, 1 - (t.bounce || 0)) * Math.sqrt(s);
                        e = {
                            ...e,
                            mass: eT.mass,
                            stiffness: s,
                        ...
                        let i = function({duration: t=eT.duration, bounce: e=eT.bounce, velocity: i=eT.velocity, mass: s=eT.mass}) {
                            let n, r;
                            tJ(t <= (0,
                            N.f)(eT.maxDuration), "Spring duration must be 10 seconds or less");
                            let o = 1 - e;
                            o = tt(eT.minDamping, eT.maxDamping, o),
                            t = tt(eT.minDuration, eT.maxDuration, (0,
                            N.X)(t)),
                            o < 1 ? (n = e => {
                                let s = e * o
                                  , n = s * t;
                                return .001 - (s - i) / eb(e, o) * Math.exp(-n)
                            }
                            ,
                            r = e => {
                                let s = e * o * t
                ...
                velocity: -(0,
                N.X)(s.velocity || 0)
            }), v = p || 0, g = h / (2 * Math.sqrt(u * d)), y = a - o, x = (0,
            N.X)(Math.sqrt(u / d)), w = 5 > Math.abs(y);
            if (n || (n = w ? eT.restSpeed.granular : eT.restSpeed.default),
            r || (r = w ? eT.restDelta.granular : eT.restDelta.default),
            g < 1) {
                let t = eb(x, g);
                ...
                i = e => {
                    let i = Math.exp(-g * x * e)
                      , s = Math.min(t * e, 300);
                    return a - i * ((v + g * x * y) * Math.sinh(s) + t * y * Math.cosh(s)) / t
                }
            }
            let P = {
                ...
                toString: () => {
                    ...
                    f.tu)(P), f.YE)
                      , e = (0,
                    f.KZ)(e => P.next(t * e).value, t, 30);
                    return t + "ms " + e
                }
            };
            return P
        }
        function eM({keyframes: t, velocity: e=0, power: i=.8, timeConstant: s=325, bounceDamping: n=10, bounceStiffness: r=500, modifyTarget: o, min: a, max: l, restDelta: u=.5, restSpeed: h}) {
            let d, c, p = t[0], m = {
                done: !1,
                value: p
            }, f = i * e, v = p + f, g = void 0 === o ? v : o(v);
            g !== v && (f = g - p);
        ...
        let eD = z(.42, 0, 1, 1)
          ...
          , eL = t => {
            if ((0,
            f.DW)(t)) {
                tQ(4 === t.length, "Cubic bezier arrays must contain four numerical values.");
                let[e,i,s,n] = t;
                return z(e, i, s, n)
            }
            return "string" == typeof t ? (tQ(void 0 !== eR[t], `Invalid easing type '${t}'`),
            eR[t]) : t
        }
        ;
        var ej = i(1225);
        function eF({duration: t=300, keyframes: e, times: i, ease: s="easeInOut"}) {
            var n;
            let r = Array.isArray(s) && "number" != typeof s[0] ? s.map(eL) : eL(s)
              , o = {
                done: !1,
                value: e[0]
            }
              , a = function(t, e, {clamp: i=!0, ease: s, mixer: n}={}) {
                let r = t.length;
                if (tQ(r === e.length, "Both input and output ranges must be the same length"),
                1 === r)
                    return () => e[0];
                if (2 === r && e[0] === e[1])
                    return () => e[1];
                ...
                let a = function(t, e, i) {
                    ...
                    for (let i = 0; i < r; i++) {
                        let r = n(t[i], t[i + 1]);
                        e && (r = ep(Array.isArray(e) ? e[i] || P.l : e, r)),
                        s.push(r)
                    }
                    return s
                }(e, s, n)
                ...
                ;
                return i ? e => u(tt(t[0], t[r - 1], e)) : u
            }((n = i && i.length === e.length ? i : function(t) {
                let e = [0];
                return !function(t, e) {
                    let i = t[t.length - 1];
                    for (let s = 1; s <= e; s++) {
            ...
            n.map(e => e * t)), e, {
                ease: Array.isArray(r) ? r : e.map( () => r || ek).splice(0, e.length - 1)
            });
            return {
        ...
        let eB = t => {
            ...
            return {
                start: () => A.update(e, !0),
                stop: () => S(e),
                now: () => V.isProcessing ? V.timestamp : D.now()
            }
        }
          , eO = {
            decay: eM,
        ...
        class eI extends en {
            constructor(t) {
                ...
                let {name: e, motionValue: i, element: s, keyframes: n} = this.options
                  , r = (null == s ? void 0 : s.KeyframeResolver) || tZ
                  , o = (t, e) => this.onKeyframesResolved(t, e);
                this.resolver = new r(n,o,e,i,s),
            ...
            initPlayback(t) {
                let e, i, {type: s="keyframes", repeat: n=0, repeatDelay: r=0, repeatType: o, velocity: a=0} = this.options, l = (0,
                f.WH)(s) ? s : eO[s] || eF;
                l !== eF && "number" != typeof t[0] && (e = ep(eU, ew(t[0], t[1])),
                t = [0, 100]);
                let u = l({
                    ...this.options,
                    keyframes: t
            ...
            tick(t, e=!1) {
                ...
                let {finalKeyframe: s, generator: n, mirroredGenerator: r, mapPercentToKeyframes: o, keyframes: a, calculatedDuration: l, totalDuration: u, resolvedDuration: h} = i;
                ...
                return T && void 0 !== s && (w.value = es(a, this.options, s)),
                f && f(w.value),
                T && this.finish(),
                w
            }
            ...
            play() {
                ...
                if (this.isStopped)
                    return;
                let {driver: t=eB, onPlay: e, startTime: i} = this.options;
        ...
        let eN = new Set(["opacity", "clipPath", "filter", "transform"])
          , e$ = (0,
        i(178).p)( () => Object.hasOwnProperty.call(Element.prototype, "animate"))
          , eW = {
            anticipate: G,
            backInOut: K,
            circInOut: J
        ...
        class ez extends en {
            constructor(t) {
                super(t);
                let {name: e, motionValue: i, element: s, keyframes: n} = this.options;
                this.resolver = new et(n, (t, e) => this.onKeyframesResolved(t, e),e,i,s),
                this.resolver.scheduleResolve()
            }
            initPlayback(t, e) {
                var i;
                let {duration: s=300, times: n, ease: r, type: o, motionValue: a, name: l, startTime: u} = this.options;
                ...
                let h = function(t, e, i, {delay: s=0, duration: n=300, repeat: r=0, repeatType: o="loop", ease: a="easeInOut", times: l}={}) {
                    let u = {
                        [e]: i
                    };
                    l && (u.offset = l);
            ...
            static supports(t) {
                ...
                return e$() && i && eN.has(i) && !a && !l && !s && "mirror" !== n && 0 !== r && "inertia" !== o
            }
        }
        let eX = {
            type: "spring",
          ...
          , eq = (t, e, i, s={}, n, r) => o => {
            ...
            !function({when: t, delay: e, delayChildren: i, staggerChildren: s, staggerDirection: n, repeat: r, repeatType: o, repeatDelay: a, from: l, elapsed: u, ...h}) {
                return !!Object.keys(h).length
            }(a) && (h = {
                ...h,
                ...( (t, {keyframes: e}) => e.length > 2 ? eH : g.has(t) ? t.startsWith("scale") ? {
                    type: "spring",
                    stiffness: 550,
            ...
            return !r && ez.supports(h) ? new ez(h) : new eI(h)
        }
        ;
        function eK(t, e, {delay: i=0, transitionOverride: s, type: n}={}) {
            var r;
            ...
            for (let e in l) {
                let s = t.getValue(e, null != (r = t.latestValues[e]) ? r : null)
                  , n = l[e];
                ...
                if (window.MotionHandoffAnimation) {
                    let i = t.props[I];
                    if (i) {
                        let t = window.MotionHandoffAnimation(i, e, A);
                        null !== t && (a.startTime = t,
                        h = !0)
                    }
                }
                O(t, e),
                s.start(eq(e, s, n, t.shouldReduceMotion && y.has(e) ? {
                    type: !1
                } : a, t, h));
                let c = s.animation;
                c && u.push(c)
                ...
                A.update( () => {
                    a && function(t, e) {
                        ...
                        for (let e in n = {
                            ...
                            let i = x(n[e]);
                            t.hasValue(e) ? t.getValue(e).set(i) : t.addValue(e, F(i))
                        }
                    }(t, a)
                }
                )
        ...
        function eG(t, e, i={}) {
            var s;
            let n = h(t, e, "exit" === i.type ? null == (s = t.presenceContext) ? void 0 : s.custom : void 0)
              , {transition: r=t.getDefaultTransition() || {}} = n || {};
            i.transitionOverride && (r = i.transitionOverride);
            let o = n ? () => Promise.all(eK(t, n, i)) : () => Promise.resolve()
              , a = t.variantChildren && t.variantChildren.size ? (s=0) => {
                ...
                return function(t, e, i=0, s=0, n=1, r) {
                    ...
                    return Array.from(t.variantChildren).sort(e_).forEach( (t, s) => {
            ...
            constructor(t) {
                ...
                t.animationState || (t.animationState = function(t) {
                    let e = e => Promise.all(e.map( ({animation: e, options: i}) => (function(t, e, i={}) {
                        ...
                        Array.isArray(e))
                            s = Promise.all(e.map(e => eG(t, e, i)));
                        else if ("string" == typeof e)
                            s = eG(t, e, i);
                        else {
                            let n = "function" == typeof e ? h(t, e, i.custom) : e;
                            s = Promise.all(eK(t, n, i))
                        }
                        return s.then( () => {
                      ...
                      , l = e => (i, s) => {
                        var n;
                        let r = h(t, s, "exit" === e ? null == (n = t.presenceContext) ? void 0 : n.custom : void 0);
                        if (r) {
                    ...
                    function u(u) {
                        ...
                        for (let e = 0; e < eQ; e++) {
                            ...
                            let c = eJ[e]
                              , x = i[c]
                              , w = void 0 !== h[c] ? h[c] : d[c]
                              , P = a(w)
                              , T = c === u ? x.isActive : null;
                            !1 === T && (v = e);
                            let b = w === d[c] && w !== h[c] && P;
                            ...
                            !x.isActive && null === T || !w && !x.prevProp || n(w) || "boolean" == typeof w)
                                continue;
                            let A = (g = x.prevProp,
                            "string" == typeof (y = w) ? y !== g : !!Array.isArray(y) && !o(y, g))
                              , S = A || c === u && x.isActive && !b && P || e > v && P
                              , V = !1
                            ...
                            for (let t in C) {
                                ...
                                if (!f.hasOwnProperty(t))
                                    (r(e) && r(i) ? o(e, i) : e === i) ? void 0 !== e && m.has(t) ? k(t) : x.protectedKeys[t] = !0 : null != e ? k(t) : m.add(t)
                            }
                            x.prevProp = w,
                        ...
                        let x = !!p.length;
                        return s && (!1 === h.initial || h.initial === h.animate) && !t.manuallyAnimateOnMount && (x = !1),
                        s = !1,
            ...
            constructor(t, e, {transformPagePoint: i, contextWindow: s, dragSnapToOrigin: n=!1}={}) {
                ...
                this.updatePoint = () => {
                    if (!(this.lastMoveEvent && this.lastMoveEventInfo))
                        return;
                    let t = is(this.lastMoveEventInfo, this.history)
                      , e = null !== this.startEvent
                      , i = function(t, e) {
                        return Math.sqrt(e8(t.x, e.x) ** 2 + e8(t.y, e.y) ** 2)
                    }(t.offset, {
                        x: 0,
                        y: 0
                    }) >= 3;
                ...
                this.handlePointerMove = (t, e) => {
                    ...
                    this.lastMoveEventInfo = ie(e, this.transformPagePoint),
                ...
                this.handlePointerUp = (t, e) => {
                    ...
                    !(this.lastMoveEvent && this.lastMoveEventInfo))
                        return;
                    let r = is("pointercancel" === t.type ? this.lastMoveEventInfo : ie(e, this.transformPagePoint), this.history);
                ...
                let r = ie(e6(t), this.transformPagePoint)
                  , {point: o} = r
                  , {timestamp: a} = V;
                this.history = [{
                    ...o,
                ...
                l && l(t, is(r, this.history)),
                this.removeListeners = ep(e7(this.contextWindow, "pointermove", this.handlePointerMove), e7(this.contextWindow, "pointerup", this.handlePointerUp), e7(this.contextWindow, "pointercancel", this.handlePointerUp))
            }
            updateHandlers(t) {
                this.handlers = t
            }
        ...
        function iu(t, e, i, s) {
            il(t.x, e.x, i.x, s ? s.originX : void 0),
            il(t.y, e.y, i.y, s ? s.originY : void 0)
        }
        function ih(t, e, i) {
            t.min = i.min + e.min,
            t.max = t.min + ia(e)
        ...
        function ib({top: t, left: e, right: i, bottom: s}) {
            return {
                x: {
                    min: e,
                    max: i
        ...
        function iS({scale: t, scaleX: e, scaleY: i}) {
            return !iA(t) || !iA(e) || !iA(i)
        }
        function iV(t) {
            return iS(t) || iE(t) || t.z || t.rotate || t.rotateX || t.rotateY || t.skewX || t.skewY
        }
        function iE(t) {
            var e, i;
            return (e = t.x) && "0%" !== e || (i = t.y) && "0%" !== i
        }
        function iM(t, e, i, s, n) {
            return void 0 !== n && (t = s + n * (t - s)),
            s + i * (t - s) + e
        }
        function iD(t, e=0, i=1, s, n) {
            t.min = iM(t.min, e, i, s, n),
            t.max = iM(t.max, e, i, s, n)
        }
        function iC(t, {x: e, y: i}) {
            iD(t.x, e.translate, e.scale, e.originPoint),
            iD(t.y, i.translate, i.scale, i.originPoint)
        }
        function ik(t, e) {
            t.min = t.min + e,
            t.max = t.max + e
        }
        function iR(t, e, i, s, n=.5) {
            let r = er(t.min, t.max, n);
            iD(t, e, i, r, s)
        }
        function iL(t, e) {
            iR(t.x, e.x, e.scaleX, e.scale, e.originX),
            iR(t.y, e.y, e.scaleY, e.scale, e.originY)
        }
        function ij(t, e) {
            return ib(function(t, e) {
                if (!e)
                    return t;
                let i = e({
                    x: t.left,
        ...
        let iF = ({current: t}) => t ? t.ownerDocument.defaultView : null
          , iB = new WeakMap;
        class iO {
            constructor(t) {
            ...
            start(t, {snapToCursor: e=!1}={}) {
                ...
                let s = t => {
                    ...
                    e && this.snapToCursor(e6(t).point)
                }
                  , n = (t, e) => {
                    ...
                    iT(t => {
                        ...
                        if (tm.test(e)) {
                            ...
                            if (i && i.layout) {
                                ...
                                s && (e = ia(s) * (parseFloat(e) / 100))
                            }
                        }
                        this.originPoint[t] = e
                    }
                    ),
                    n && A.postRender( () => n(t, e)),
                ...
                this.panSession = new it(t,{
                    ...
                    dragSnapToOrigin: l,
                    contextWindow: iF(this.visualElement)
                })
            }
            stop(t, e) {
            ...
            updateAxis(t, e, i) {
                ...
                if (!i || !iU(t, s, this.currentDirection))
                    return;
                let n = this.getAxisMotionValue(t)
                  , r = this.originPoint[t] + i[t];
                this.constraints && this.constraints[t] && (r = function(t, {min: e, max: i}, s) {
                    return void 0 !== e && t < e ? t = s ? er(e, t, s.min) : Math.max(t, e) : void 0 !== i && t > i && (t = s ? er(i, t, s.max) : Math.min(t, i)),
                    t
            ...
            resolveConstraints() {
                ...
                let {dragConstraints: e, dragElastic: i} = this.getProps()
                  ...
                  , n = this.constraints;
                e && io(e) ? this.constraints || (this.constraints = this.resolveRefConstraints()) : e && s ? this.constraints = function(t, {top: e, left: i, bottom: s, right: n}) {
                    return {
                        x: ip(t.x, i, n),
                        y: ip(t.y, e, s)
                    }
                ...
                n !== this.constraints && s && this.constraints && !this.hasMutatedConstraints && iT(t => {
            ...
            resolveRefConstraints() {
                ...
                if (!e || !io(e))
                    return !1;
                let s = e.current;
                tQ(null !== s, "If `dragConstraints` is set as a React ref, that ref must be passed to another component's `ref` prop.");
            ...
            startAnimation(t) {
                ...
                return Promise.all(iT(o => {
                    if (!iU(o, e, this.currentDirection))
                        return;
                    let l = a && a[o] || {};
                    r && (l = {
                        min: 0,
            ...
            startAxisValueAnimation(t, e) {
                ...
                return O(this.visualElement, t),
                i.start(eq(t, i, 0, e, this.visualElement, !1))
            }
            stopAnimation() {
            ...
            snapToCursor(t) {
                iT(e => {
                    ...
                    if (!iU(e, i, this.currentDirection))
                        return;
                    ...
                    if (e && !1 !== this.constraints) {
                        ...
                        s[t] = function(t, e) {
                            let i = .5
                              ...
                              , n = ia(e);
                            return n > s ? i = (0,
                            ej.q)(e.min, e.max - s, t.min) : s > n && (i = (0,
                            ej.q)(t.min, t.max - n, e.min)),
                            tt(0, 1, i)
                        }({
                            min: i,
                            max: i
            ...
            addListeners() {
                ...
                let t = e7(this.visualElement.current, "pointerdown", t => {
                  ...
                  , e = () => {
                    ...
                    io(t) && t.current && (this.constraints = this.resolveRefConstraints())
                }
                  , {projection: i} = this.visualElement
                ...
                i.updateLayout()),
                A.read(e);
                let n = e4(window, "resize", () => this.scalePositionWithinConstraints())
        ...
        class i$ extends e2 {
            constructor() {
                super(...arguments),
                this.removePointerDownListener = P.l
            }
            onPointerDown(t) {
                this.session = new it(t,this.createPanHandlers(),{
                    transformPagePoint: this.node.getTransformPagePoint(),
                    contextWindow: iF(this.node)
                })
            }
            createPanHandlers() {
                ...
                return {
                    ...
                    onEnd: (t, e) => {
                        delete this.session,
                        s && A.postRender( () => s(t, e))
                    }
                }
            }
            mount() {
                this.removePointerDownListener = e7(this.node.current, "pointerdown", t => this.onPointerDown(t))
            }
            update() {
            ...
            correct: (t, e) => {
                ...
                if ("string" == typeof t)
                    if (!tf.test(t))
                        ...
                        t = parseFloat(t);
                let i = iK(t, e.target.x)
                  , s = iK(t, e.target.y);
                return `${i}% ${s}%`
            }
        }
          , i_ = {}
          , {schedule: iZ, cancel: iJ} = b(queueMicrotask, !1);
        class iQ extends iz.Component {
            componentDidMount() {
            ...
            getSnapshotBeforeUpdate(t) {
                ...
                t.isPresent !== n && (n ? r.promote() : r.relegate() || A.postRender( () => {
                    let t = r.getStack();
        ...
        let i9 = ["TopLeft", "TopRight", "BottomLeft", "BottomRight"]
          , i4 = i9.length
          , i6 = t => "string" == typeof t ? parseFloat(t) : t
          , i7 = t => "number" == typeof t || tf.test(t);
        function i8(t, e) {
        ...
        function sa(t, e, [i,s,n], r, o) {
            !function(t, e=0, i=1, s=.5, n, r=t, o=t) {
                if (tm.test(e) && (e = parseFloat(e),
                e = er(o.min, o.max, e / 100) - o.min),
                "number" != typeof e)
                    return;
        ...
        let sl = ["x", "scaleX", "originX"]
          , su = ["y", "scaleY", "originY"];
        function sh(t, e, i, s) {
            sa(t.x, e, sl, i ? i.x : void 0, s ? s.x : void 0),
            sa(t.y, e, su, i ? i.y : void 0, s ? s.y : void 0)
        }
        function sd(t) {
        ...
        function sS({attachResizeListener: t, defaultParent: e, measureScroll: i, checkIsScrollRoot: s, resetTransform: n}) {
            return class {
                constructor(t={}, i=null == e ? void 0 : e()) {
                    ...
                    this.updateProjection = () => {
                        this.projectionUpdateScheduled = !1,
                        sw && (sx.totalNodes = sx.resolvedTargetDeltas = sx.recalculatedProjection = 0),
                        this.nodes.forEach(sM),
                        this.nodes.forEach(sF),
                        this.nodes.forEach(sB),
                        this.nodes.forEach(sD),
                        sw && window.MotionDebug.record(sx)
                    }
                    ,
                ...
                addEventListener(t, e) {
                    return this.eventHandlers.has(t) || this.eventHandlers.set(t, new R),
                ...
                mount(e, i=this.root.hasTreeAnimated) {
                    ...
                    t) {
                        ...
                        t(e, () => {
                            ...
                            iq.hasAnimatedSinceResize && (iq.hasAnimatedSinceResize = !1,
                    ...
                    !1 !== this.options.animate && r && (s || n) && this.addEventListener("didUpdate", ({delta: t, hasLayoutChanged: e, hasRelativeTargetChanged: i, layout: s}) => {
                        ...
                        let n = this.options.transition || r.getDefaultTransition() || sW
                          , {onLayoutAnimationStart: o, onLayoutAnimationComplete: a} = r.getProps()
                          , l = !this.targetLayout || !sf(this.targetLayout, s) || i
                          , u = !e && i;
                ...
                willUpdate(t=!0) {
                    ...
                    if (window.MotionCancelOptimisedAnimation && !this.hasCheckedOptimisedAppear && function t(e) {
                        ...
                        if (window.MotionHasOptimisedAnimation(s, "transform")) {
                            ...
                            window.MotionCancelOptimisedAnimation(s, "transform", A, !(t || i))
                        }
                        let {parent: n} = e;
                ...
                update() {
                    ...
                    this.clearAllSnapshots();
                    let t = D.now();
                    V.delta = tt(0, 1e3 / 60, t - V.timestamp),
                    V.timestamp = t,
                    V.isProcessing = !0,
                    E.update.process(V),
                    E.preRender.process(V),
                    E.render.process(V),
                    V.isProcessing = !1
                }
                didUpdate() {
                    this.updateScheduled || (this.updateScheduled = !0,
                    iZ.read(this.scheduleUpdate))
                }
                clearAllSnapshots() {
                    this.nodes.forEach(sC),
                    this.sharedNodes.forEach(sU)
                }
                ...
                resetTransform() {
                    ...
                    let t = this.isLayoutDirty || this.shouldResetTransform || this.options.alwaysMeasureLayout
                      , e = this.projectionDelta && !sc(this.projectionDelta)
                      , i = this.getTransformTemplate()
                      , s = i ? i(this.latestValues, "") : void 0
                      , r = s !== this.prevTransformTemplateValue;
                    t && (e || iV(this.latestValues) || r) && (n(this.instance, s),
                    this.shouldResetTransform = !1,
                    this.scheduleRender())
                }
                measure(t=!0) {
                ...
                measurePageBox() {
                    ...
                    if (!((null == (t = this.scroll) ? void 0 : t.wasRoot) || this.path.some(sq))) {
                ...
                removeElementScroll(t) {
                    ...
                    for (let e = 0; e < this.path.length; e++) {
                        ...
                        s !== this.root && n && r.layoutScroll && (n.wasRoot && sn(i, t),
                        ik(i.x, n.offset.x),
                        ik(i.y, n.offset.y))
                    }
                    return i
                ...
                applyTransform(t, e=!1) {
                    ...
                    for (let t = 0; t < this.path.length; t++) {
                        let s = this.path[t];
                        !e && s.options.layoutScroll && s.scroll && s !== s.root && iL(i, {
                            x: -s.scroll.offset.x,
                            y: -s.scroll.offset.y
                        }),
                        iV(s.latestValues) && iL(i, s.latestValues)
                    }
                    return iV(this.latestValues) && iL(i, this.latestValues),
                    i
                }
                removeTransform(t) {
                    let e = iP();
                    ...
                    for (let t = 0; t < this.path.length; t++) {
                        let i = this.path[t];
                        if (!i.instance || !iV(i.latestValues))
                            continue;
                        iS(i.latestValues) && i.updateSnapshot();
                        let s = iP();
                        sn(s, i.measurePageBox()),
                        sh(e, i.latestValues, i.snapshot ? i.snapshot.layoutBox : void 0, s)
                    }
                    return iV(this.latestValues) && sh(e, this.latestValues),
                    e
                }
                setTargetDelta(t) {
                    this.targetDelta = t,
                ...
                resolveTargetDelta(t=!1) {
                    ...
                    if (this.layout && (a || l)) {
                        if (this.resolvedRelativeTargetAt = V.timestamp,
                        !this.targetDelta && !this.relativeTarget) {
                            let t = this.getClosestProjectingParent();
                            t && t.layout && 1 !== this.animationProgress ? (this.relativeParent = t,
                            this.forceRelativeParentToResolveTarget(),
                            this.relativeTarget = iP(),
                            this.relativeTargetOrigin = iP(),
                        ...
                        if (this.relativeTarget || this.targetDelta) {
                            if ((this.target || (this.target = iP(),
                            this.targetWithTransforms = iP()),
                            this.relativeTarget && this.relativeTargetOrigin && this.relativeParent && this.relativeParent.target) ? (this.forceRelativeParentToResolveTarget(),
                            i = this.target,
                            s = this.relativeTarget,
                            n = this.relativeParent.target,
                            ih(i.x, s.x, n.x),
                            ih(i.y, s.y, n.y)) : this.targetDelta ? (this.resumingFrom ? this.target = this.applyTransform(this.layout.layoutBox) : sn(this.target, this.layout.layoutBox),
                            iC(this.target, this.targetDelta)) : sn(this.target, this.layout.layoutBox),
                            ...
                            sw && sx.resolvedTargetDeltas++
                        }
                    }
                }
                getClosestProjectingParent() {
                    if (!(!this.parent || iS(this.parent.latestValues) || iE(this.parent.latestValues)))
                ...
                calcProjection() {
                    ...
                    !function(t, e, i, s=!1) {
                        ...
                        if (o) {
                            ...
                            for (let a = 0; a < o; a++) {
                                ...
                                (!o || !o.props.style || "contents" !== o.props.style.display) && (s && n.options.layoutScroll && n.scroll && n !== n.root && iL(t, {
                                    x: -n.scroll.offset.x,
                                    y: -n.scroll.offset.y
                                }),
                                r && (e.x *= r.x.scale,
                                e.y *= r.y.scale,
                                iC(t, r)),
                                s && iV(n.latestValues) && iL(t, n.latestValues))
                            }
                    ...
                    this.projectionDelta && this.prevProjectionDelta ? (sr(this.prevProjectionDelta.x, this.projectionDelta.x),
                    sr(this.prevProjectionDelta.y, this.projectionDelta.y)) : this.createProjectionDeltas(),
                    iu(this.projectionDelta, this.layoutCorrected, l, this.latestValues),
                    this.treeScale.x === o && this.treeScale.y === a && sg(this.projectionDelta.x, this.prevProjectionDelta.x) && sg(this.projectionDelta.y, this.prevProjectionDelta.y) || (this.hasProjected = !0,
                    this.scheduleRender(),
                    this.notifyListeners("projectionUpdate", l)),
                    sw && sx.recalculatedProjection++
                }
                hide() {
                    this.isVisible = !1
                }
                ...
                setAnimationOrigin(t, e=!1) {
                    ...
                    let a = iP()
                      ...
                      , d = !!(l && !h && !0 === this.options.crossfade && !this.path.some(s$));
                    this.animationProgress = 0,
                    this.mixTargetDelta = e => {
                        ...
                        this.relativeTarget && this.relativeTargetOrigin && this.layout && this.relativeParent && this.relativeParent.layout) {
                            ...
                            c = i,
                            sp(u.x, c.x) && sp(u.y, c.y)) && (this.isProjectionDirty = !1),
                            i || (i = iP()),
                            sn(i, this.relativeTarget)
                        }
                        l && (this.animationValues = r,
                        function(t, e, i, s, n, r) {
                            n ? (t.opacity = er(0, void 0 !== i.opacity ? i.opacity : 1, st(s)),
                            t.opacityExit = er(void 0 !== e.opacity ? e.opacity : 1, 0, se(s))) : r && (t.opacity = er(void 0 !== e.opacity ? e.opacity : 1, void 0 !== i.opacity ? i.opacity : 1, s));
                            for (let n = 0; n < i4; n++) {
                                let r = `border${i9[n]}Radius`
                                  , o = i8(e, r)
                                  , a = i8(i, r);
                                (void 0 !== o || void 0 !== a) && (o || (o = 0),
                                a || (a = 0),
                                0 === o || 0 === a || i7(o) === i7(a) ? (t[r] = Math.max(er(i6(o), i6(a), s), 0),
                                (tm.test(a) || tm.test(o)) && (t[r] += "%")) : t[r] = a)
                            }
                            (e.rotate || i.rotate) && (t.rotate = er(e.rotate || 0, i.rotate || 0, s))
                ...
                startAnimation(t) {
                    ...
                    this.pendingAnimation && (S(this.pendingAnimation),
                    this.pendingAnimation = void 0),
                    this.pendingAnimation = A.update( () => {
                        iq.hasAnimatedSinceResize = !0,
                        this.currentAnimation = function(t, e, i) {
                            let s = B(0) ? 0 : F(t);
                            return s.start(eq("", s, 1e3, i)),
                            s.animation
                        }(0, 0, {
                            ...t,
                            onUpdate: e => {
                ...
                applyTransformsToTarget() {
                    ...
                    if (e && i && s) {
                        if (this !== t && this.layout && s && sY(this.options.animationType, this.layout.layoutBox, s.layoutBox)) {
                            i = this.target || iP();
                            let e = ia(this.layout.layoutBox.x);
                            i.x.min = t.target.x.min,
                            i.x.max = i.x.min + e;
                            let s = ia(this.layout.layoutBox.y);
                            i.y.min = t.target.y.min,
                            i.y.max = i.y.min + s
                        }
                        sn(e, i),
                        iL(e, n),
                        iu(this.projectionDeltaWithTransform, this.layoutCorrected, e, n)
                    }
                }
                ...
                resetSkewAndRotation() {
                    ...
                    !e)
                        return;
                    let s = {};
                    i.z && sA("z", t, s, this.animationValues);
                    for (let e = 0; e < sP.length; e++)
                        sA(`rotate${sP[e]}`, t, s, this.animationValues),
                        sA(`skew${sP[e]}`, t, s, this.animationValues);
                ...
                getProjectionStyles(t) {
                    ...
                    if (this.needsReset)
                        ...
                        s.opacity = "",
                        s.pointerEvents = i3(null == t ? void 0 : t.pointerEvents) || "",
                    ...
                    if (!this.projectionDelta || !this.layout || !r.target) {
                        ...
                        e.pointerEvents = i3(null == t ? void 0 : t.pointerEvents) || ""),
                        this.hasProjected && !iV(this.latestValues) && (e.transform = n ? n({}, "") : "none",
                        this.hasProjected = !1),
                        e
                    }
                    ...
                    r.animationValues ? s.opacity = r === this ? null != (i = null != (e = o.opacity) ? e : this.latestValues.opacity) ? i : 1 : this.preserveOpacity ? this.latestValues.opacity : o.opacityExit : s.opacity = r === this ? void 0 !== o.opacity ? o.opacity : "" : void 0 !== o.opacityExit ? o.opacityExit : 0,
                    i_) {
                        if (void 0 === o[t])
                            continue;
                        let {correct: e, applyTo: i} = i_[t]
                    ...
                    return this.options.layoutId && (s.pointerEvents = r === this ? i3(null == t ? void 0 : t.pointerEvents) || "" : "none"),
                    s
                }
                clearSnapshot() {
        ...
        function sE(t) {
            ...
            if (t.isLead() && t.layout && i && t.hasListeners("didUpdate")) {
                ...
                iu(o, e, i.layoutBox);
                let a = ix();
                r ? iu(a, t.applyTransform(s, !0), i.measuredBox) : iu(a, e, i.layoutBox);
                let l = !sc(o)
                  , u = !1;
                if (!t.resumeFrom) {
        ...
        function sN(t, e, i, s) {
            t.min = er(e.min, i.min, s),
            t.max = er(e.max, i.max, s)
        }
        function s$(t) {
        ...
        let sW = {
          ...
          , sz = t => "undefined" != typeof navigator && navigator.userAgent && navigator.userAgent.toLowerCase().includes(t)
          , sX = sz("applewebkit/") && !sz("chrome/") ? Math.round : P.l;
        function sH(t) {
            t.min = sX(t.min),
            t.max = sX(t.max)
        }
        function sY(t, e, i) {
            return "position" === t || "preserve-aspect" === t && !(.2 >= Math.abs(sv(e) - sv(i)))
        }
        function sq(t) {
            var e;
        ...
        let sK = sS({
            attachResizeListener: (t, e) => e4(t, "resize", e),
            measureScroll: () => ({
        ...
        function sZ(t, e, i) {
            ...
            let n = s["onHover" + i];
            n && A.postRender( () => n(e, e6(e)))
        }
        class sJ extends e2 {
            mount() {
                let {current: t} = this.node;
                t && (this.unmount = (0,
                f.PT)(t, t => (sZ(this.node, t, "Start"),
                t => sZ(this.node, t, "End"))))
            }
            unmount() {}
        }
        class sQ extends e2 {
            ...
            mount() {
                this.unmount = ep(e4(this.node.current, "focus", () => this.onFocus()), e4(this.node.current, "blur", () => this.onBlur()))
            }
            unmount() {}
        }
        function s0(t, e, i) {
        ...
        class s1 extends e2 {
            mount() {
                let {current: t} = this.node;
                t && (this.unmount = (0,
                f.c$)(t, t => (s0(this.node, t, "Start"),
                (t, {success: e}) => s0(this.node, t, e ? "End" : "Cancel")), {
            ...
            startObserver() {
                ...
                let {viewport: t={}} = this.node.getProps()
                  ...
                  , r = {
                    ...
                    rootMargin: i,
                    threshold: "number" == typeof s ? s : s4[s]
                }
                  , o = t => {
                ...
                let l = function({root: t, ...e}) {
                    ...
                    let s = s5.get(i)
                      , n = JSON.stringify(e);
                    return s[n] || (s[n] = new IntersectionObserver(s9,{
                        root: t,
                        ...e
                    })),
                    s[n]
        ...
        let nn = "undefined" != typeof window
          , nr = {
        ...
        for (let t in nr)
            no[t] = {
                isEnabled: e => nr[t].some(t => !!e[t])
            };
        let na = Symbol.for("motionComponentSymbol")
          , nl = nn ? iz.useLayoutEffect : iz.useEffect
          , nu = ["animate", "circle", "defs", "desc", "ellipse", "g", "image", "line", "filter", "marker", "mask", "metadata", "path", "pattern", "polygon", "polyline", "rect", "stop", "switch", "symbol", "svg", "text", "tspan", "use", "view"];
        function nh(t) {
            if ("string" != typeof t || t.includes("-"))
                ;
            else if (nu.indexOf(t) > -1 || /[A-Z]/u.test(t))
                return !0;
            return !1
        }
        let nd = t => (e, i) => {
            ...
            iz.useContext)(nt)
              , r = (0,
            iz.useContext)(iX)
              , o = () => (function({scrapeMotionValuesFromProps: t, createRenderState: e, onUpdate: i}, s, r, o) {
                let a = {
          ...
          , nc = (t, e) => e && "number" == typeof t ? e.transform(t) : t
          , np = {
            x: "translateX",
            y: "translateY",
            z: "translateZ",
        ...
        function ny(t, e, i) {
            return "string" == typeof t ? t : tf.transform(e + i * t)
        }
        function nx(t, {attrX: e, attrY: i, attrScale: s, originX: n, originY: r, pathLength: o, pathSpacing: a=1, pathOffset: l=0, ...u}, h, d) {
            if (nf(t, u, d),
            h) {
            ...
            void 0 !== o && function(t, e, i=1, s=0, n=!0) {
                t.pathLength = 1;
                let r = n ? nv : ng;
                t[r.offset] = tf.transform(-s);
                let o = tf.transform(e)
                  , a = tf.transform(i);
                t[r.array] = `${o} ${a}`
            }(c, o, a, l, !1)
        }
        let nw = () => ({
          ...
          , nT = t => "string" == typeof t && "svg" === t.toLowerCase();
        function nb(t, {style: e, vars: i}, s, n) {
            for (let r in Object.assign(t.style, e, n && n.getProjectionStyles(s)),
            i)
                t.style.setProperty(r, i[r])
        }
        let nA = new Set(["baseFrequency", "diffuseConstant", "kernelMatrix", "kernelUnitLength", "keySplines", "keyTimes", "limitingConeAngle", "markerHeight", "markerWidth", "numOctaves", "targetX", "targetY", "surfaceScale", "specularConstant", "specularExponent", "stdDeviation", "tableValues", "viewBox", "gradientTransform", "pathLength", "startOffset", "textLength", "lengthAdjust"]);
        function nS(t, e, i, s) {
            for (let i in nb(t, e, void 0, s),
            e.attrs)
                t.setAttribute(nA.has(i) ? i : U(i), e.attrs[i])
        }
        function nV(t, {layout: e, layoutId: i}) {
            return g.has(t) || t.startsWith("origin") || (e || void 0 !== i) && (!!i_[t] || "opacity" === t)
        }
        function nE(t, e, i) {
            var s;
            let {style: n} = t
              , r = {};
            for (let o in n)
                (B(n[o]) || e.style && B(e.style[o]) || nV(o, t) || (null == (s = null == i ? void 0 : i.getValue(o)) ? void 0 : s.liveStyle) !== void 0) && (r[o] = n[o]);
            return r
        }
        function nM(t, e, i) {
            let s = nE(t, e, i);
            for (let i in t)
                (B(t[i]) || B(e[i])) && (s[-1 !== v.indexOf(i) ? "attr" + i.charAt(0).toUpperCase() + i.substring(1) : i] = t[i]);
            return s
        }
        let nD = ["x", "y", "width", "height", "cx", "cy", "r"]
          , nC = {
            useVisualState: nd({
                ...
                onUpdate: ({props: t, prevProps: e, current: i, renderState: s, latestValues: n}) => {
                    ...
                    o && A.read( () => {
                        ...
                        A.render( () => {
                            nx(s, n, nT(i.tagName), t.transformTemplate),
                            nS(i, s)
                        }
                        )
                    }
        ...
        function nR(t, e, i) {
            for (let s in e)
                B(e[s]) || nV(s, i) || (t[s] = e[s])
        }
        let nL = new Set(["animate", "exit", "variants", "initial", "style", "values", "variants", "transition", "transformTemplate", "custom", "inherit", "onBeforeLayoutMeasure", "onAnimationStart", "onAnimationComplete", "onUpdate", "onDragStart", "onDrag", "onDragEnd", "onMeasureDragConstraints", "onDirectionLock", "onDragTransitionEnd", "_dragX", "_dragY", "onHoverStart", "onHoverEnd", "onViewportEnter", "onViewportLeave", "globalTapTarget", "ignoreStrict", "viewport"]);
        function nj(t) {
            return t.startsWith("while") || t.startsWith("drag") && "draggable" !== t || t.startsWith("layout") || t.startsWith("onTap") || t.startsWith("onPan") || t.startsWith("onLayout") || nL.has(t)
        }
        let nF = t => !nj(t);
        try {
            !function(t) {
                t && (nF = e => e.startsWith("on") ? !nj(e) : t(e))
        ...
        class n$ {
            ...
            mount(t) {
                ...
                this.shouldReduceMotion = "never" !== this.reducedMotionConfig && ("always" === this.reducedMotionConfig || nB.current),
                this.parent && this.parent.children.add(this),
                this.update(this.props, this.presenceContext)
            }
            unmount() {
                for (let t in nI.delete(this.current),
            ...
            measureViewportBox() {
                return this.current ? this.measureInstanceViewportBox(this.current, this.props) : iP()
            }
            getStaticValue(t) {
            ...
            getValue(t, e) {
                ...
                let i = this.values.get(t);
                return void 0 === i && void 0 !== e && (i = F(null === e ? void 0 : e, {
                    owner: this
                }),
                this.addValue(t, i)),
                i
            ...
            readValue(t, e) {
                ...
                if (null != s) {
                    if ("string" == typeof s && (t0(s) || Q(s)))
                        s = parseFloat(s);
                    else {
                        let i;
                        i = s,
                        !nU.find(t6(i)) && tD.test(e) && (s = tU(t, e))
                    }
                    this.setBaseTarget(t, B(s) ? s.get() : s)
                }
                return B(s) ? s.get() : s
            }
            setBaseTarget(t, e) {
            ...
            getBaseTarget(t) {
                ...
                if ("string" == typeof s || "object" == typeof s) {
                    let n = u(this.props, s, null == (e = this.presenceContext) ? void 0 : e.custom);
                    n && (i = n[t])
                }
                if (s && void 0 !== i)
                    return i;
                let n = this.getBaseTargetFromProps(this.props, t);
                return void 0 === n || B(n) ? void 0 !== this.initialValues[t] && void 0 === i ? void 0 : this.baseTarget[t] : n
            }
            on(t, e) {
                return this.events[t] || (this.events[t] = new R),
                this.events[t].add(e)
            }
            notify(t, ...e) {
        ...
        class nX extends nW {
            constructor() {
                ...
                this.type = "svg",
                this.isSVGTag = !1,
                this.measureInstanceViewportBox = iP
            }
            getBaseTargetFromProps(t, e) {
                return t[e]
            }
            ...
            build(t, e, i) {
                nx(t, e, this.isSVGTag, i.transformTemplate)
            }
            renderInstance(t, e, i, s) {
                nS(t, e, i, s)
            }
            mount(t) {
                this.isSVGTag = nT(t.tagName),
                super.mount(t)
            }
        }
        let nH = function(t) {
        ...
        m = (t, e) => nh(t) ? new nX(e) : new nz(e,{
            allowProjection: t !== iz.Fragment
        }),
        function(t, {forwardMotionProps: e}={
            ...
            return function(t) {
                var e, i;
                let {preloadedFeatures: s, createVisualElement: n, useRender: r, useVisualState: o, Component: l} = t;
                function u(t, e) {
                    var i;
                    let s, u = {
                        ...(0,
                    ...
                    if (!h && nn) {
                        ...
                        d.visualElement = function(t, e, i, s, n) {
                            ...
                            iz.useContext)(iX)
                              , h = (0,
                            iz.useContext)(s8).reducedMotion
                              , d = (0,
                            iz.useRef)(null);
                            s = s || l.renderer,
                            ...
                            c && !c.projection && n && ("html" === c.type || "svg" === c.type) && function(t, e, i, s) {
                                let {layoutId: n, layout: r, drag: o, dragConstraints: a, layoutScroll: l, layoutRoot: u} = e;
                            ...
                            let f = i[I]
                              , v = (0,
                            iz.useRef)(!!f && !(null == (r = window.MotionHandoffIsComplete) ? void 0 : r.call(window, f)) && (null == (o = window.MotionHasOptimisedAnimation) ? void 0 : o.call(window, f)));
                            return nl( () => {
                                c && (m.current = !0,
                    ...
                    iW.jsxs)(nt.Provider, {
                        value: d,
                        children: [s && d.visualElement ? (0,
                        iW.jsx)(s, {
                            visualElement: d.visualElement,
                            ...u
                        }) : null, r(l, t, (i = d.visualElement,
                        (0,
                        iz.useCallback)(t => {
                            t && c.onMount && c.onMount(t),
                            i && (t ? i.mount(t) : i.unmount()),
                            e && ("function" == typeof e ? e(t) : io(e) && (e.current = t))
                        }
                ...
                u.displayName = "motion.".concat("string" == typeof l ? l : "create(".concat(null != (i = null != (e = l.displayName) ? e : l.name) ? i : "", ")"));
                let h = (0,
                iz.forwardRef)(u);
                return h[na] = l,
                h
                ...
                useRender: function(t=!1) {
                    return (e, i, s, {latestValues: n}, r) => {
                        let o = (nh(e) ? function(t, e, i, s) {
                            let n = (0,
                            iz.useMemo)( () => {
                                let i = nP();
                                return nx(i, e, nT(s), t.transformTemplate),
                                {
                                    ...i.attrs,
                                    style: {
                                        ...i.style
                        ...
                        : function(t, e) {
                          ...
                          , a = function(t, e, i) {
                            let s = {};
                            for (let n in t)
                                ("values" !== n || "object" != typeof t.values) && (nF(n) || !0 === i && nj(n) || !e && !nj(n) || t.draggable && n.startsWith("onDrag")) && (s[n] = t[n]);
                            return s
                        }(i, "string" == typeof e, t)
                          , l = e !== iz.Fragment ? {
                            ...a,
    ...
    4294: (t, e, i) => {
        ...
        let o = (0,
        s.forwardRef)( (t, e) => {
            let {color: i="currentColor", size: o=24, strokeWidth: a=2, absoluteStrokeWidth: l, className: u="", children: h, iconNode: d, ...c} = t;
            return (0,
            s.createElement)("svg", {
                ref: e,
                ...r,
          ...
          , a = (t, e) => {
            ...
            s.forwardRef)( (i, r) => {
                ...
                s.createElement)(o, {
                    ref: r,
                    iconNode: e,
                    className: n("lucide-".concat(t.replace(/([a-z0-9])([A-Z])/g, "$1-$2").toLowerCase()), a),
                    ...l
                })
            }
            );
